	...
	<table class="table table-striped table-bordered">
		...
		<tr>
			...
			<th>操作</th>
				...
				<td>
				<?php if($rows['dongjie'] == 0 ): echo "未被冻结"; ?>
				<?php else: ?>
					<?php  echo "已被冻结"; endif; ?>
				</td>
				<td><?php echo ($rows['tel']); ?></td>
				<td style="width:100px;">
					<a href="__URL__/changestate/id/<?php echo ($row['id']); ?>" class="btn btn-danger del" idx="<?php echo ($row['id']); ?>">
						<?php if($rows['dongjie'] == 0 ): echo "冻结"; ?>
						<?php else: ?>
						    <?php  echo "解冻"; endif; ?>
					</a>
				</td>
