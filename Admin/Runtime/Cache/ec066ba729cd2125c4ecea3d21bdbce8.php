...
<body>
	...
	<form action="__URL__/change" class="form-horizontal" method="post">
        <div class="form-group">
            ...
            <div class="col-sm-6">
               <input type="text" name="dingdanhao" class="form-control" id="inputEmail3" readonly="" value="<?php echo ($rows['dingdanhao']); ?>">
            </div>
        </div> 
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <select class="form-control" name="zt">
                  <option value="<?php echo ($rows['zt']); ?>"><?php echo ($rows['zt']); ?></option>
                  <option value="已收款">已收款</option>
                  <option value="已发货">已发货</option>
                  <option value="未做任何处理">未做任何处理</option>
              </select>
            </div>
        </div>  
