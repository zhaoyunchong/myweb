...
<body>
    ...
    <table class="table table-striped table-bordered table-hover">
		<div class="row">
    	    <div class="col-md-9">
    		    <h3 class="page-header" style="color: #000;margin-top:0px;">
    	         <a href="__URL__/index" class="btn btn-primary">返回</a>
    	         <span style="margin-left: 400px;">本次订单详情</span>
                </h3> 
    	   </div>
        </div>
        <tr>
        ...
        <?php $__FOR_START_12798__=0;$__FOR_END_12798__=$tot;for($i=$__FOR_START_12798__;$i < $__FOR_END_12798__;$i+=1){ ?><tr>
        		<th><?php echo ($arr2[$i]); ?></th>
			    <th>
                   <img src="__PUBLIC__/uploads/<?php echo ($arr1[$i]); ?>" alt="">         
                </th>
			    <th>
                   <a href="__URL__/ping/spid/<?php echo ($arr3[$i]); ?>" class="btn btn-info btn-lg">评论</a>         
                </th>
        	</tr><?php } ?>
	</table>
