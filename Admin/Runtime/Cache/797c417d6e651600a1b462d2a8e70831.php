...
<body>
	...
	<table class="table table-striped table-bordered table-hover">
		...
		<tr>
			...
			<td><?php echo ($rows['dingdanhao']); ?></td>
			<td><?php echo ($rows['xiadanren']); ?></td>
			<td><?php echo ($rows['zfff']); ?></td>
			<td><?php echo ($rows['shff']); ?></td>
			<td><?php echo ($rows['zt']); ?></td>
			<td><a href="__URL__/look/id/<?php echo ($row['id']); ?>" class="btn btn-info">详情</a></td>
			<td><a href="javacript:>" class="btn btn-danger del" idx="<?php echo ($row['id']); ?>">修改</a></td>
		</tr>
