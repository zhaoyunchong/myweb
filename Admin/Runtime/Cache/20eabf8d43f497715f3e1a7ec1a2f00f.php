	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-10 rightinfo">
					...
					<div class="jumbotron">
					<h1>欢迎回到后台管理系统!</h1>
					<img src="../Public/img/hy.jpg" width="100%">
					<br>
					<br>
					<a href="__ROOT__/index.php" class='btn btn-primary btn-lg'>网站首页</a>
					<a href="__APP__/Login/logout" class='btn btn-danger btn-lg' onclick='return confirm("您确认退出吗?")'>退出后台</a>
				</div>
